...
const Message =(props)=>{
    ...
    return(
        ...
        >   
        <View style={{alignItems:'center',justifyContent:'center',backgroundColor:colorSchema.brown,padding:7,marginLeft:10,borderRadius:10}}>
            <Text style={[commonstyles.txt,{fontFamily:'reg',fontSize:16,color:colorSchema.white}]}>{props.message}</Text>
        </View>
        </Animated.View>
